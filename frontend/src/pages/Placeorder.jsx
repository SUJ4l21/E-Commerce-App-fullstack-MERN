...
const Placeorder = () => {
  const { navigate, backendUrl, token, setCartItem, getCartAmount, delivery_fee, products, cartItem } = useContext(Scontext);
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5  sm:pt-14 min-h-[40vh] border-t '>
      {/* Leftside */}
