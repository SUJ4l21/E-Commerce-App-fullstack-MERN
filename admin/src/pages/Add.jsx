    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      <div>
        ...
        <div className='flex gap-2'>
          <label htmlFor="image1">
            ...
            }} type="file" id="image1" accept="image/*" hidden />
          </label>
          <label htmlFor="image2">
            ...
            }} type="file" id="image2" accept="image/*" hidden />
          </label>
          <label htmlFor="image3">
            ...
            }} type="file" id="image3" accept="image/*" hidden />
          </label>
          <label htmlFor="image4">
            ...
            }} type="file" id="image4" accept="image/*" hidden />
          </label>
        </div>
      </div>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} className='w0full px-3 py-2 sm:w-[120px]' type="number" placeholder='0' />
        </div>
      </div>
